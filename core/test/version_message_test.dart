...
void main() {
  group('VersionMessage', () {
    final int protocolVersion = 70015; // Bitcoin protocol version
    final int services = 1; // NODE_NETWORK service
    final int timestamp = 1616325658; // Fixed timestamp for testing
    ...
    test('should serialize to correct binary format', () {
      ...
      final extractedUserAgentBytes = payload.sublist(offset, offset + userAgentBytes.length);
    ...
    test('factory create should generate valid message with current timestamp', () {
